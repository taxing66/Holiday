...
import jw.cn.com.jwutils.model.PostParam;
 ...
 */
public class ServiceDataImpl implements JWIServiceData {
    /**
     * 服务器数据的 data 层
     */
    ...
    public static ServiceDataImpl createServiceData(int status, String dataJson) {
        return new ServiceDataImpl(status, dataJson);
    }

    private ServiceDataImpl(int status, String dataJson) {
